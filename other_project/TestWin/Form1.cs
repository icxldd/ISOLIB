    ...
    public partial class Form1 : Form
    {
        ...
        private void InitializeEncodeLib()
        {
            try
            {
                ...
                if (encodeLib.IsLoaded)
                {
                    ...
                    temp = EncodeLibManager.Instance.GenerateRSAKeyPair();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int result = EncodeLibManager.Instance.EncryptFile(inputFile, encryptedFile, temp.PublicKey, OnProgress);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int result = EncodeLibManager.Instance.DecryptFile(inputFile, decryptedFile, temp.PrivateKey, OnProgress);
